...
public class ViewPagerHWActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_pager_hw_layout);
        ...
        viewThird = layoutInflater.inflate(R.layout.view_thrid,null);
